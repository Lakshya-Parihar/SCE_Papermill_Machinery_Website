...
<input type="text" name="admin_password" class="form-control" required value="<?php echo $admin_pass; ?>">
...
$update_admin = "UPDATE admin SET admin_name = '$admin_name', admin_email = '$admin_email', admin_password='$admin_pass',admin_contact='$admin_contact' WHERE admin_id = '$admin_id'";
